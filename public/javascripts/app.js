...
require.register("scripts/Chart", function(exports, require, module) {
/*!
 * Chart.js
 * http://chartjs.org/
...
// My Example
 var albumGuardians = {
   ...
   label: 'Marvel',
   year: '2014',
   albumArtUrl: '/images/guardians.jpg',
   songs: [
       { name: 'Hooked on a Feeling', length: '2:52' },
       { name: 'Go All the Way', length: '3:21' },
       { name: 'Spirit in the Sky', length: '4:02'},
       { name: 'Moonage Daydream', length: '4:41' },
       { name: 'Fooled Around and Fell in Love', length: '4:35'}
     ]
 };
